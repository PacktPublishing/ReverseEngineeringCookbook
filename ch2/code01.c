...
BOOL read_reg(){
	LSTATUS lResult = RegOpenKeyEx (HKEY_CURRENT_USER, "randomtest", 0, KEY_READ, NULL);
...
void file(){
    ...
    GetTempFileNameA(".","ch2",0,TempPath);
	...
	WriteFile(hTempFile, errMsg, sizeof(errMsg),NULL, NULL); 
}
